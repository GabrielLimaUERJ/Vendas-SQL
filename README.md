# 🛒 Análise de Vendas - SQL + Streamlit
...
Analisar o desempenho de vendas conectando diretamente a um banco SQL, permitindo:  
...
- Python  
- Pandas  
- DuckDB (SQL para análise eficiente de grandes datasets)  
...
- Conexão com banco de dados SQL ou DuckDB  
- Extração e transformação de dados de vendas  
...
- Depende da qualidade do banco de dados ou CSV importado  
- Análise limitada aos campos presentes no dataset  
